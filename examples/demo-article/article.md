...
![开源配图 Skill 如何让图像成为解释的一部分](assets/image/cover.png)
...
![先判断读者卡点再生成配图](assets/image/plan-before-pixels.png)
...
![把段落关系、图法选择与文章锚点连接起来](assets/image/paragraph-grammar-anchor.png)
...
![文章结构、图法与编辑图母版各自承担不同职责](assets/image/content-grammar-master.png)
...
![用边界图区分编辑解释系统与应排除的视觉噪声](assets/image/editorial-style-boundary.png)
...
![从生成候选到质量检查、准确锚点与可追溯交付](assets/image/traceable-delivery.png)
